...
class TestDBCreation:
    ...
    def test_db_creation(self, settings):
        ...
        db_response = test_steps.get_database(session, headers, settings['SUPERSET_DATABASE_NAME'])
        database_id = db_response[0]['id']
        dataset_creation_response = test_steps.create_dataset(session, headers, database_id)
